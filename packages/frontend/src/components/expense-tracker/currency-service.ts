...
export class CurrencyService {
  private baseCurrency: SupportedCurrency;
  private exchangeRates: CurrencyRates;

  constructor(baseCurrency: SupportedCurrency = "USD") {
    this.baseCurrency = baseCurrency;
    this.exchangeRates = EXCHANGE_RATES_TO_USD;
  }
  ...
  getBaseCurrency(): SupportedCurrency {
  ...
  getCurrencyInfo(currencyCode: SupportedCurrency): CurrencyInfo | undefined {
